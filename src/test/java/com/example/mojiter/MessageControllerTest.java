package com.example.mojiter;

import com.example.mojiter.controller.MessageController;
...
public class MessageControllerTest {
    ...
    public void addMessageToListTest() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/span").string("text5"))
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/i").string("#tag5"));
    }
}
